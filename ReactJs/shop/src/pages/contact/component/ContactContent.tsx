...
import { ContactInput, MessageInput } from '../../../components/input';
import { IFormContactValue } from '../../../domain/contact';
export const ContactContent = () => {
    const { register, handleSubmit, formState: {errors} } = useForm<IFormContactValue>();
    return (
        <div className='my-24'>
            <div className='flex flex-col items-center text-center'>
                <h1 className='text-4xl font-semibold'>Get In Touch With Us</h1>
                <p className='text-quickSilver text-base font-normal mt-2'>For More Information About Our Product & Services. Please Feel
                    Free To Drop Us<br /> An Email. Our Staff Always Be There To Help
                    You Out. Do Not Hesitate!</p>
            </div>
            <div className='mt-36 flex'>
                <div className='flex-1 flex items-center flex-col gap-11'>
                ...
                <div className='flex-1 flex items-center'>
                    <form className='flex flex-col gap-9' onSubmit={handleSubmit(() => { })}>
                        ...
                        <MessageInput
                            ...
                            errors={errors}
                        />
                        <button className='rounded-2xl w-60 h-12 border-black 
                        border-solid border-[1px] text-base font-normal'>Submit</button>
                    </form>
                </div>
            </div>
        </div>
